 ...
 */
@Service
public class DescontoStrategyEstadual implements DescontoStrategy {
    ...
    private void aplicarCalculo(Frete frete) {
        // FIXME: Se CEP's tiverem o mesmo UF e DDD diferentes
        //  aplicar 75% desconto no valor total
        //  aplicar 3 dias de previsão de entrega
